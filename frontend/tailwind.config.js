  ...
  theme: {
    extend: {
      colors: {
        ...
        "secondary-container": "#f1ddbd",
        primary: "#9c3e1e",
        "secondary-fixed": "#f4e0c0",
      ...
      borderRadius: {
        // Tighter than the first Sa'ei screens: cards read as 8px, controls 4px.
        DEFAULT: "0.125rem",
        lg: "0.25rem",
        xl: "0.5rem",
        full: "9999px",
      ...
      fontSize: {
        // The 2026-09-24 type scale. label-lg / headline-xl are not in it but
        // are kept so markup written against the earlier scale still renders.
